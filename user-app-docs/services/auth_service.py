# .\user-app-docs\services\auth_service.py
import hashlib
import uuid
...
from dbschemas.auth_schema import User  # 既に `hashed_password` を使用
...
engine = create_engine(settings.DOCAPP_DB_URL, future=True, pool_pre_ping=True)
